...
def create_presentation():
    ...
    slide = prs.slides.add_slide(prs.slide_layouts[6])
    set_slide_bg(slide, NAVY)
    add_section_header(slide, "3", "CARA KERJA KASUBAG ANALIS", "Review & Verifikasi Awal Pengajuan Kredit", GREEN)
    ...
    slide = prs.slides.add_slide(prs.slide_layouts[6])
    set_slide_bg(slide, NAVY)
    add_section_header(slide, "4", "CARA KERJA KABAG KREDIT", "Evaluasi Risiko Kredit & Penilaian Agunan", ORANGE)
    ...
    slide = prs.slides.add_slide(prs.slide_layouts[6])
    set_slide_bg(slide, NAVY)
    add_section_header(slide, "5", "CARA KERJA KADIV BISNIS", "Approval Divisi & Threshold Keputusan Kredit", PURPLE)
    ...
    slide = prs.slides.add_slide(prs.slide_layouts[6])
    set_slide_bg(slide, NAVY)
    add_section_header(slide, "6", "CARA KERJA DIREKSI", "Persetujuan Final untuk Kredit Bernilai Besar (≥ Rp 500 Juta)", RED)
    ...
    slide = prs.slides.add_slide(prs.slide_layouts[6])
    set_slide_bg(slide, NAVY)
    add_section_header(slide, "7", "CARA KERJA ADMIN / SUPERADMIN", "Manajemen Sistem, User, Parameter & Monitoring", GOLD)
