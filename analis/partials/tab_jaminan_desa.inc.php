<div id="tab-jaminan" class="tab-content desa-penghasilan-container">
    ...
    <div class="desa-form-grid desa-grid-2">
        <div class="desa-form-group">
            <label class="desa-label">SK / Surat Keputusan Jabatan</label>
            <input
                type="text"
                ...
                placeholder="Isi di tab Analisa (Nomor SK)"
            >
            <small class="desa-helper">Diambil otomatis dari Nomor SK pada tab Analisa</small>
        </div>
...
document.addEventListener('DOMContentLoaded', function () {
    function syncDesaSkJabatanDisplay() {
        var source = document.getElementById('desk_no_sk');
    ...
    var deskNoSk = document.getElementById('desk_no_sk');
    if (deskNoSk) {
        deskNoSk.addEventListener('input', syncDesaSkJabatanDisplay);
        deskNoSk.addEventListener('change', syncDesaSkJabatanDisplay);
    }
