...
function calc6C() {
  ...
  categories.forEach(function(cat){
      ...
      var grade = '';
      if (avg > 0 && avg < 1.5) grade = '1 — Tidak Baik';
      ...
      var qualText = '';
      if (avg > 0 && avg < 1.5) qualText = 'Skor rendah, risiko sangat tinggi.';
      ...
      else if (avg >= 4.5) qualText = 'Skor sangat tinggi, risiko sangat rendah.';
  ...
  var grade = '';
  if (total > 0 && total < 1.5) grade = 'Tidak Baik';
