    ...
    <div class="container">
        ...
        <div class="card" style="margin-bottom: 2rem;">
                        ...
                        <div
                            ...
                            <div style="text-align:center;">
                                <span style="display:block; font-size:0.75rem; color:#be185d;">
                                    Nilai Taksasi (<?= ($jt['kategori_agunan'] == 'sawah_tegal') ? '70%' : '75%' ?>)
                                </span>
                                <span
                ...
                foreach ($jaminan_kendaraan as $jk):
                    ...
                    <div
                        ...
                        <div style="display:flex; justify-content:space-between; align-items:center;">
                            ...
                            <div style="text-align:center;">
                                <span style="display:block; font-size:0.75rem; color:#64748B;">Taksasi (60%)</span>
                                <span
            ...
            <div style="background: #F8FAFC; padding: 1.5rem; border-left: 4px solid #3B82F6; margin-bottom: 2rem; border-radius:0 0.5rem 0.5rem 0; clear: both;">
                <h3 style="color:#1E40AF; margin-bottom:1rem;">III. Neraca (Posisi Keuangan)</h3>
                <div style="display:grid; grid-template-columns: 1fr 1fr; gap: 2rem;">
                    <div>
                        ...
                        <table style="width:100%; font-size:0.95rem;">
                            <tr><td style="color:#64748B;">Kas & Bank</td><td style="text-align:right; font-weight:600;"><?= formatRupiah(($neraca['aktiva_kas']??0) + ($neraca['aktiva_bank']??0)) ?></td></tr>
                            ...
                            <tr><td style="color:#64748B;">Lainnya (Stok dll)</td><td style="text-align:right; font-weight:600;"><?= formatRupiah(($neraca['aktiva_stok']??0) + ($neraca['aktiva_lainnya']??0)) ?></td></tr>
                            <tr><td colspan="2"><hr style="margin:0.25rem 0;"></td></tr>
                            <tr><td style="color:#065F46; font-weight:bold;">T O T A L</td><td style="text-align:right; font-weight:bold; color:#065F46;"><?= formatRupiah($neraca['total_aktiva']??0) ?></td></tr>
                        </table>
                    </div>
                    <div>
                        <h5 style="color:#DC2626; border-bottom:1px solid #EF4444; padding-bottom:0.5rem; margin-bottom:0.5rem;">Total Pasiva</h5>
                        <table style="width:100%; font-size:0.95rem;">
                            <tr><td style="color:#64748B;">Pinjaman Berjalan</td><td style="text-align:right; font-weight:600;"><?= formatRupiah($neraca['pasiva_hutang_bank']??0) ?></td></tr>
                            ...
                            <tr><td colspan="2"><hr style="margin:0.25rem 0;"></td></tr>
                            <tr><td style="color:#991B1B; font-weight:bold;">T O T A L</td><td style="text-align:right; font-weight:bold; color:#991B1B;"><?= formatRupiah($neraca['total_pasiva']??0) ?></td></tr>
                        </table>
                    </div>
                </div>
            </div>
            ...
            <div style="background: #FEF3C7; padding: 1.5rem; border-left: 4px solid #F59E0B; margin-bottom: 2rem; border-radius:0 0.5rem 0.5rem 0; clear: both;">
                ...
                <div style="display:flex; gap:1rem; flex-wrap:wrap; align-items:center;">
                    <div style="background:#fff8e1; border:1px solid #fcd34d; border-radius:8px; padding:0.75rem 1.25rem; flex:1;">
                        ...
                        <div style="font-size:1.5rem; font-weight:800; color:#B45309;"><?= $s6c_total ?> <span style="font-size:0.85rem; color:#92400E;">/30</span></div>
                    </div>
                    <div style="background:#fff8e1; border:1px solid #fcd34d; border-radius:8px; padding:0.75rem 1.25rem; flex:1;">
                        <span style="font-size:0.8rem; color:#92400E; font-weight:600;">REKOMENDASI</span>
                        <?php $rek_color = (strtoupper($s6c_rekomendasi) === 'LAYAK') ? '#059669' : '#DC2626'; ?>
                        <div style="font-size:1.1rem; font-weight:800; color:<?= $rek_color ?>;"><?= htmlspecialchars(strtoupper($s6c_rekomendasi)) ?></div>
                    </div>
